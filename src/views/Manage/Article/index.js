                ...
                >
                    <Form ref={this.state.addForm} labelCol={{ 'span': 4 }}>
                        ...
                        <Form.Item label="文章标签" name="activeTag">
                            <Select allowClear mode="multiple" placeholder="请选择文章标签" notFoundContent="暂无内容">
